    ...
    <div className="flex min-h-screen flex-col bg-secondary">
      ...
      <div className="container text-center my-16">
        ...
        <div className="m-auto my-20">
          <h2 className="my-10 text-transparent bg-clip-text bg-gradient-to-br from-lightblue to-primary text-3xl font-bold">
            Content Generation Tools
          </h2>
          <p className="text-justify mx-10 my-10 md:mx-15 lg:mx-40">
            Unleashing a spectrum of question diversity, this feature empowers
            users to effortlessly create Multiple Choice Questions (MCQs), Short
            Answer Questions (SAQs), and detailed case studies. It enriches
            understanding and analytical skills, providing a dynamic and
        ...
        <div className="m-auto my-20">
          ...
          <p className="text-justify mx-10 my-10 md:mx-15 lg:mx-40">
            ...
            comprehensive exploration of any topic through title/word lookup. It
            creates a robust understanding, fostering an enriched and nuanced
            perspective.
          </p>
          <div className="flex justify-center flex-wrap mx-20">
            <FeatureBox
        ...
        <div className="m-auto my-20">
          ...
          <p className="text-justify mx-10 my-10 md:mx-15 lg:mx-40">
            ...
            correctness and upholds content authenticity. The grammar validation
            tool refines written content to professional standards, while the
            plagiarism checker and remover maintain the integrity of educational
            submissions.
          </p>
          <div className="flex justify-center flex-wrap mx-20">
            <FeatureBox
        ...
        <div className="m-auto my-20">
          ...
          <p className="text-justify mx-10 my-10 md:mx-15 lg:mx-40">
            Simplifying study strategies, this component generates comprehensive
            course outlines, roadmaps, and objectives. By providing structure
            and clarity, it guides users strategically through their educational
            journey, fostering purposeful learning paths.
          </p>
          <div className="flex justify-center flex-wrap mx-20">
            <FeatureBox
